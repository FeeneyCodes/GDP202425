...
public:
	CMouseState();
	void UpdateStateFromGLUT( int button, int state, int x, int y, int modifiers );
	void UpdateStateFromGLUT( int x, int y, int modifiers );
	...
	int getScreenCentreX(void);
	int getScreenCentreY(void);
	float getScreenCentreXnormalized(void);
	float getScreenCentreYnormalized(void);

	// Get mouse position from the centre of screen.
	// If screen params haven't been set (i.e. they are zero), then returns zero
	int getXFromCentre(void);
	int getYFromCentre(void);
	float getXFromCentreNormalized(void);
	float getYFromCentreNormalized(void);
	//
