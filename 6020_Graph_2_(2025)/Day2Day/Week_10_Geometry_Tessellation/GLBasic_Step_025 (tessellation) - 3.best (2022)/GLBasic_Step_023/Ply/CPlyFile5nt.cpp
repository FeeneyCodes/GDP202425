...
void CPlyFile5nt::m_setIndexBasedOnPropertyName(int curIndex, std::wstring propName)
{
	...
	// Added: March 14, 2012
	if ( propName == L"nx" ) { this->m_PlyHeaderInfo.normx_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	if ( propName == L"ny" ) { this->m_PlyHeaderInfo.normy_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	if ( propName == L"nz" ) { this->m_PlyHeaderInfo.normz_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	// End of Added
	...
	if ( propName == L"u" )	{ this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == L"v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// Added: November 1, 2014
	if ( propName == L"texture_u" )	{ this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == L"texture_v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// ...so these ones aren't in any 'normal' ply file
	if ( propName == L"tex0u" ) { this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == L"tex0v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == L"tex1u" ) { this->m_PlyHeaderInfo.tex1u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == L"tex1v" ) { this->m_PlyHeaderInfo.tex1v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// End of Added
...
void CPlyFile5nt::m_setIndexBasedOnPropertyNameASCII(int curIndex, std::string propName)
{
	...
	// Added: March 14, 2012
	if ( propName == "nx" ) { this->m_PlyHeaderInfo.normx_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	if ( propName == "ny" ) { this->m_PlyHeaderInfo.normy_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	if ( propName == "nz" ) { this->m_PlyHeaderInfo.normz_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadNormalsInFile = true; return; }
	// End of Added

	if ( propName == "r")	{ this->m_PlyHeaderInfo.red_propertyIndex = curIndex; return; }
	if ( propName == "red")	{ this->m_PlyHeaderInfo.red_propertyIndex = curIndex; return; }
	if ( propName == "g")	{ this->m_PlyHeaderInfo.green_propertyIndex = curIndex; return; }
	if ( propName == "green")	{ this->m_PlyHeaderInfo.green_propertyIndex = curIndex; return; }
	if ( propName == "b")	{ this->m_PlyHeaderInfo.blue_propertyIndex = curIndex; return; }
	if ( propName == "blue")	{ this->m_PlyHeaderInfo.blue_propertyIndex = curIndex; return; }
	
	// Added: March 14, 2012
	// Textures... note: ply only defines one texture coord...
	if ( propName == "u" )	{ this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == "v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// Added: November 1, 2014
	if ( propName == "texture_u" )	{ this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == "texture_v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// ...so these ones aren't in any 'normal' ply file
	if ( propName == "tex0u" ) { this->m_PlyHeaderInfo.tex0u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == "tex0v" ) { this->m_PlyHeaderInfo.tex0v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == "tex1u" ) { this->m_PlyHeaderInfo.tex1u_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	if ( propName == "tex1v" ) { this->m_PlyHeaderInfo.tex1v_propertyIndex = curIndex; this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile = true; return; }
	// End of Added
...
// Added March 14, 2012
bool CPlyFile5nt::bHadTextureCoordinatesInFile(void)
{
	return this->m_PlyHeaderInfo.bHadTextureCoordinatesInFile;
}

bool CPlyFile5nt::bHadNormalsInFile(void)
{
	return this->m_PlyHeaderInfo.bHadNormalsInFile;
}
...
//void CPlyFile5nt::Scale( float scale, CVector3f origin )
//{
