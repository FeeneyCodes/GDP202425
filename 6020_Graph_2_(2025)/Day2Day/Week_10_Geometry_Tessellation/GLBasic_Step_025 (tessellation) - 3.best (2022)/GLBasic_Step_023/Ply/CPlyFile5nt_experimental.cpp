...
//static 
const float CPlyFile5nt::CDataReader::m_DEFAULTROUNDSMALLFLOATTOZEROVALUE = 0.001f;

CPlyFile5nt::CDataReader::CDataReader()
{
	this->m_bRoundSmallFloatToZeroFlag = true;
	this->m_roundToZeroValue = CPlyFile5nt::CDataReader::m_DEFAULTROUNDSMALLFLOATTOZEROVALUE;
	return;
}
