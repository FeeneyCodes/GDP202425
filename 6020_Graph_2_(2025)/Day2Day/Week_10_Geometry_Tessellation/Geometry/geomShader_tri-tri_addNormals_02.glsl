...
in vec4 gColour[];				// Triangles so this is 0 to 2
...
// If we are drawing the debug face normals, then the 4th value here is 1.0f
...
/*uniform*/ bool bGenerateNormals = true;			// Default is 0 (or FALSE)
/*uniform*/ bool bDrawDebugNormals = true;			// Default is 0 (or FALSE)
/*uniform*/ float debugNormalLength = 5.0f;

//uniform mat4 matModel;
uniform mat4 mView;
uniform mat4 mProjection;
uniform mat4 mModelInverseTranspose;	
...
//	fDebugColourOverride = vec4(1.0f, 1.0f, 1.0f, 0.0f);
	...
	if ( bDrawDebugNormals )
	{
		...
		mat4 matMVPGenNormal = mProjection * mView * matModelGeneratedNormal;
...
//		fDebugColourOverride = yellowRGBA;
		...
		fColour.rgba = vec4( 1.0f, 1.0f, 0.0f, 1.0f );	// Yellow
		// This is already in "world space" so I don't need to multiply it by a matrix
		// But I could: fVertWorldLocation = matModelGeneratedNormal * vert1Position;	
