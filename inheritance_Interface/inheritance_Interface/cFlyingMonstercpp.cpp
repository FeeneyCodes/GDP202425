...
void cFlyingMonster::Attack(void)
{
	std::cout << "cFlyingMonster: ";
	this->pTheSword->Swing();
	return;
}

void cFlyingMonster::ReceiveGift(std::string theGift)
{
	std::cout << "cFlyingMonster recieved a " << theGift << std::endl;
	return;
}